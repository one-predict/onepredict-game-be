...
export class CryptoCompareDigitalAssetsApi implements DigitalAssetsApi {
  ...
  private ASSET_ID_TO_FSYM_MAP: Record<DigitalAssetId, string> = {
    ...
    [DigitalAssetId.Wif]: 'WIF',
    [DigitalAssetId.Pepe]: 'PEPE',
    [DigitalAssetId.Bome]: 'BOME',
    [DigitalAssetId.Neiro]: 'NEIRO',
    [DigitalAssetId.Turbo]: 'TURBO',
    [DigitalAssetId.Bonk]: 'BONK',
    [DigitalAssetId.Dogs]: 'DOGS',
    [DigitalAssetId.Meme]: 'MEME',
    [DigitalAssetId.Floki]: 'FLOKI',
    [DigitalAssetId.Notcoin]: 'NOT',
    [DigitalAssetId.Hmstr]: 'HMSTR',
    [DigitalAssetId.Popcat]: 'POPCAT',
    [DigitalAssetId.Mew]: 'MEW',
    [DigitalAssetId.Cati]: 'CATI',
    [DigitalAssetId.Banana]: 'BANANA',
    [DigitalAssetId.SunDog]: 'SUNDOG',
    [DigitalAssetId.Brett]: 'BRETT',
    [DigitalAssetId.BabyDoge]: 'BABYDOGE',
